...
def meanShift_clustering_writeCSV_plotMap(the_dir,date,list_of_index,quantile):
	...
	out_csv_file_name = "%s/LABELCSV/labelClusters_%s"%(MeanShiftResult_DIR,file_name)
    #function
...
if __name__ == "__main__":
	...
	for date in new_list_of_date[0:1]:
		meanShift_clustering_writeCSV_plotMap(sample_dir , date, range(4,6) ,quantile)
